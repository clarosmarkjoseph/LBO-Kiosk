...
//    String myGender = "";
    ...
    public RecyclerWaiverForm(FragmentActivity activity) {
        ...
        this.objWaiverAnswer    = activitySingleton.Instance().getWaivers();
        try {
            ...
            view.switchAnswerAndQuestion.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (position==0){
                        ...
                        if (isChecked == true){
                            activitySingleton.Instance().setClientCycleStatus(true);
                            alertQuestion(view,position,view.waiver_message, "Remarks");
                        }
                        else{
                            activitySingleton.Instance().setClientCycleStatus(false);
                            view.linearRemarks.setVisibility(View.GONE);
                            view.lblRemarks.setText("");
                            updateWaiver(false,view,"");
                        }
    ...
    public void alertQuestion(final ViewHolder view, final int position,String message,String waiver_placeholder){
        ...
        final Dialog waiverDialog = new Dialog(context);
        waiverDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        waiverDialog.setContentView(R.layout.popup_waiver);
        TextView lblWaiverTitle      = (TextView) waiverDialog.findViewById(R.id.lblWaiverTitle);
        TextView lblWaiverQuestion   = (TextView) waiverDialog.findViewById(R.id.lblWaiverQuestion);
        Button btnCancel             = (Button) waiverDialog.findViewById(R.id.btnCancel);
        Button btnConfirm            = (Button) waiverDialog.findViewById(R.id.btnConfirm);
        ImageButton imgBtnClose      = (ImageButton) waiverDialog.findViewById(R.id.imgBtnClose);
        final EditText txtAnswer     = (EditText) waiverDialog.findViewById(R.id.txtAnswer);
        ...
        waiverDialog.setCanceledOnTouchOutside(false);
        waiverDialog.setCancelable(false);
        waiverDialog.show();
    }
